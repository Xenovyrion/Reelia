...
fun ShowPreviewScreen(
    ...
    Scaffold { padding ->
        ...
        Column(
            ...
            BackdropHeader(imageUrl = uiState.backdropUrl ?: uiState.posterUrl, contentDescription = uiState.title, onBack = onBack)
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
                    val metadata = listOfNotNull(
                        uiState.numberOfSeasons?.let { "$it saisons" },
                ...
                if (uiState.networkNames.isNotEmpty()) {
                    Text(
                        uiState.networkNames.joinToString(", "),
